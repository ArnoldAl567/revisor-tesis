...
const translations = {
  es: {
    ...
    "upload.error.apiOffline": "No se pudo conectar con la API configurada ({apiUrl}). Revisa NEXT_PUBLIC_API_URL en Vercel y que el backend de Render este activo.",
    "upload.error.noProviders": "No hay motor de IA disponible. Configura OPENAI_API_KEY o GEMINI_API_KEY en las variables de entorno del backend en Render.",
    "upload.status.loadingProviders": "Verificando motores de IA disponibles...",
    "upload.status.selectFile": "Seleccione un documento Word o PDF para continuar.",
  ...
  en: {
    ...
    "upload.error.apiOffline": "Could not connect to the configured API ({apiUrl}). Check NEXT_PUBLIC_API_URL in Vercel and that the Render backend is running.",
    "upload.error.noProviders": "No AI engine is available. Set OPENAI_API_KEY or GEMINI_API_KEY in the Render backend environment variables.",
    "upload.status.loadingProviders": "Checking available AI engines...",
    "upload.status.selectFile": "Select a Word or PDF document to continue.",
